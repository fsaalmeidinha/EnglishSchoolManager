...
jQuery.validator.addMethod("dateNL",function(a,b){return this.optional(b)||/^\d\d?[\.\/-]\d\d?[\.\/-]\d\d\d?\d?$/.test(a)},"Vul hier een geldige datum in.");jQuery.validator.addMethod("time",function(a,b){return this.optional(b)||/^(__:__|(|[0-1][0-9]|[2][0-3]):[0-5][0-9])$/.test(a)},"Please enter a valid time, between 00:00 and 23:59");
