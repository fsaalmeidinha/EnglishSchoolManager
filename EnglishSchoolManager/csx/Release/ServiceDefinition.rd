...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="EnglishSchoolManager" generation="1" functional="0" release="0" Id="a40954a8-f795-46d5-bdc9-b757a5ab5eb8" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
  ...
  <implements>
    <implementation Id="dbd86913-5489-468e-a37f-8834d5f4d038" ref="Microsoft.RedDog.Contract\ServiceContract\EnglishSchoolManagerContract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="55e3c516-995b-45d5-af7c-a4ace36a3760" ref="Microsoft.RedDog.Contract\Interface\ESMWeb:Endpoint1@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/EnglishSchoolManager/EnglishSchoolManagerGroup/ESMWeb:Endpoint1" />
          </inPort>
        </interfaceReference>
        <interfaceReference Id="91165cf8-0750-4c6a-ae1b-9ddd72c06000" ref="Microsoft.RedDog.Contract\Interface\ESMWeb:Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/EnglishSchoolManager/EnglishSchoolManagerGroup/ESMWeb:Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput" />
          </inPort>
        </interfaceReference>
